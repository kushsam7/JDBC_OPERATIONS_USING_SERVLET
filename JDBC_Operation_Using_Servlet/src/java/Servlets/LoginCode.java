...
public class LoginCode extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet LoginCode</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            if (rs.next())
             {
                 ...
                 out.print("<script>window.location.href='student_reg.jsp';</script>");
             }
             else
             {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(LoginCode.class.getName()).log(Level.SEVERE, null, ex);
